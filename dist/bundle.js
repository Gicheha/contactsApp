...
var ContactsApp = function (_Component) {
    ...
    function ContactsApp() {
        ...
        var _this = _possibleConstructorReturn(this, (ContactsApp.__proto__ || Object.getPrototypeOf(ContactsApp)).call(this));
    ...
    _createClass(ContactList, [{
        ...
        value: function render() {
            ...
            var filteredContacts = this.props.contacts.filter(function (contact) {
                return contact.name.indexOf(_this4.props.filterText) !== -1;
            });
...
(0, _reactDom.render)(_react2.default.createElement(ContactsApp, { contacts: contacts }), document.getElementById('root'));
